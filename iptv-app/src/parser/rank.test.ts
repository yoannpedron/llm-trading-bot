...
const m = (competition: string, home: string, away: string, state: Match['state'] = 'pre'): Match => ({ id: 'x', sport: 'football', competition, home, away, start: new Date(Date.now() + 5 * 3600e3), state, source: 'espn' })
describe('importance', () => {
